...
const say = 'say ';
//const voice = ' -v Amelie ';

//let's make a function that speaks
function speak(whatosay, voice) {
  //speak the string
  exec(say + ' -v ' + voice + ' ' + whatosay);
  //log it to the console
  console.log(whatosay)
}

let repeatingFunction1 = setInterval(() => {
  speak("A chacun son choix se dit sa sœur Sylvie, suivant son chemin", "Ellen");
}, 1000);

let repeatingFunction2 = setInterval(() => {
    speak("As-tu été à Tahiti ?");
  },
  2000);

// let repeatingFunction2 = setInterval(function() {
//   speak("chemin son suivant, Sylvie soeur sa dit se choix son chacun a ", "Thomas");
// }, 1800);
